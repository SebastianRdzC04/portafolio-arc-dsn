---
title: "Manual de Usuario — El Roble Eventos"
description: "Guía de navegación y uso del sitio web El Roble Eventos para el cliente final: acceso, secciones del Inicio y Catálogo de Servicios."
date: 2026-03-04
draft: false
order: 4
tags: ["Manual de Usuario", "UX", "El Roble", "Guía"]
---

# Manual de Usuario — El Roble Eventos

Este manual te guía paso a paso por todas las secciones del sitio web de **El Roble Eventos**, para que puedas navegar y encontrar la información que necesitas sin dificultad.

---

## 1. Acceso al Sitio

Abre tu navegador (Google Chrome, Firefox, Safari o Edge) y visita:

> **https://elroble.devas.sbs/**

No se requiere registro ni inicio de sesión. El sitio es de acceso libre y público.

---

## 2. Interfaz 1 — Página de Inicio (`/`)

La página de inicio se divide en cuatro secciones que puedes recorrer haciendo **scroll hacia abajo**.
...
- **¿Cómo avanzar?** Continúa haciendo scroll.
...
- Las tarjetas se animan al entrar al campo de visión (efecto fade-in desde los lados).
- **¿Cómo ver precios?** Dirígete al Catálogo de Servicios (ver sección 3).
- **¿Cómo avanzar?** Continúa haciendo scroll.

> Si la sección aparece vacía, el servidor puede estar temporalmente fuera de línea. Intenta recargar la página.

---

### Sección D — Ubicación y Contacto
...
### Navegación desde el NavBar (barra superior)
...
- **"Catalogo de Servicios 2025"** — Te lleva a la segunda sección del sitio (ver sección 3).
...
## 3. Interfaz 2 — Catálogo de Servicios (`/services-catalog`)

El Catálogo de Servicios es una segunda sección del sitio con un diseño tipo **revista o folleto digital**. Puedes llegar aquí desde el NavBar → "Catalogo de Servicios 2025".
...
En cada sección de espacio (Salón, Alberca, Salón/Quinta) encontrarás al final una nota con los costos por hora adicional:

- **Hora extra día del evento:** $400
- **Hora extra anticipada:** $250

---

### ¿Cómo Apartar una Fecha?
